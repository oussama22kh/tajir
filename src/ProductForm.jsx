...
import { Button, TextField, Typography, Box, Avatar, Grid } from "@mui/material";
...
const ProductUpdate = () => {
    ...
    const getProductData = async () => {
        ...
        try {
            const response = await axios.get('http://127.0.0.1:8000/api/product', config);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://127.0.0.1:8000/api/storeProduct', formData , config);
    ...
    return (
        <Box display="flex" flexDirection="column" alignItems="center" mt={4}>
            ...
            <Box width="70%">
                ...
                {message && (
                    <Typography variant="body2" style={{ color: 'green', marginTop: '20px' }}>
                        {message}
                    </Typography>
                )}
                {error && (
